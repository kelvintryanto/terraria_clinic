  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-violet-800/80 via-violet-600 to-violet-800">
      ...
      <div className="flex min-h-screen pt-16">
        {/* Sidebar - Changed to auto height and better mobile sizing */}
        <div className="fixed top-16 left-0 w-20 md:w-64 z-20">
          <div className="p-3 md:p-4">
            <ProfileCard />
          </div>
        </div>

        {/* Main Content - Adjusted margin to match new sidebar width */}
