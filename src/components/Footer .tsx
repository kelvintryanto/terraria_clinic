...
const Footer = () => {
  return (
    <div className="bg-violet-800 text-white p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="grid-cols-1 flex flex-col gap-2">
          ...
          {/* <div className="flex flex-wrap text-sm">
            <p>Perawatan terbaik untuk anjing kesayangan Anda dengan keahlian terpercaya sejak 2005</p>
          </div> */}
          <div className="flex gap-1 items-center text-sm">
            <MapPin size={20} />
            <h3>Jln. Platina 2 No.18 Desa Curug, Kec. Gunung Sindur, Parung Kabupaten Bogor - Jawa Barat</h3>
          </div>
          <div className="flex items-center gap-2">
            <h3 className="text-sm mr-1">Follow Us: </h3>
            <Link href="https://www.instagram.com/official_rumahterraria/" target="_blank">
              <svg role="img" fill="#ffffff" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center mt-10">East Mountain @ 2025</div>
    </div>
  );
};
