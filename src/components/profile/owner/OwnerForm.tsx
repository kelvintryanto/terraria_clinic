  ...
  return (
    <div className="bg-gradient-to-br from-violet-900/40 via-purple-900/30 to-violet-800/20 backdrop-blur-md rounded-xl p-6 border border-violet-500/10 shadow-lg w-full sm:w-2/3 md:w-1/2 lg:1/3 lg:py-8 px-14">
      <div className="flex flex-col gap-5 items-center">
        <h1 className="text-xl font-bold text-orange-500">Owner Profile Form</h1>
        ...
        <motion.form initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="w-full space-y-4 text-white">
          ...
          <div>
            ...
            <Input type="email" placeholder="Masukkan email" className="w-full mt-1" />
          </div>

          <div>
            <label className="block text-sm font-medium">Nomor HP</label>
            <Input type="tel" placeholder="Masukkan nomor HP" className="w-full mt-1" />
          </div>

          <div>
            <label className="block text-sm font-medium">Alamat</label>
            <Textarea placeholder="Masukkan alamat lengkap" className="w-full mt-1" />
          </div>
