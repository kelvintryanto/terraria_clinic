      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl md:text-6xl font-serif mb-4">
            ...
            <span className="text-orange-500">Menjaga dengan Pengalaman</span>
          </h1>
          <p className="text-base md:text-lg text-gray-200 mb-8">
            Dengan pengalaman lebih dari 10 tahun, kami menyediakan solusi
            perawatan yang berkualitas.
          </p>
          <Link href="#booking">
            <button className="px-8 py-3 bg-orange-500 hover:bg-orange-600 text-black font-semibold rounded-lg transition-colors">
              Booking Sekarang
            </button>
          </Link>
        </div>
