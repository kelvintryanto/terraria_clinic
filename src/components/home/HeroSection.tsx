...
export default function HeroSection() {
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 from-5% via-black/60 via-70% to-purple-200/70 to-100%" />
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-8">Dengan pengalaman lebih dari 10 tahun, kami menyediakan solusi perawatan yang berkualitas.</p>
          <Link href="#subscribe">
